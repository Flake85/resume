<template>
    <b-card :bg-variant="secondaryCardBG" text-variant="light">
        ...
        <b-form-group label="Location:" label-cols="3" label-class="text-sm-right" label-for="location" label-size="sm">
            <b-form-input :disabled="isValid" id="location" v-model="location" type="text" placeholder="School Location"></b-form-input>
        </b-form-group>

        <div id="school">
            <b-form-group label-cols="3" label="Accomplishments:" label-class="text-sm" label-for="title" label-size="sm">
                <b-form-input :disabled="isValid" class="merit" v-model="merit1" type="text" placeholder="(E.g. degree, diploma, certificate, etc)"></b-form-input>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            isValid(){ return !this.$store.state.education.school1.schoolName },
            schoolName: {
                get() { return this.$store.state.education.school1.schoolName },
                set(schoolName) { this.$store.commit('updateSchoolName1', schoolName) }
            },
            startMonth: {
                get() { return this.$store.state.education.school1.startMonth },
                set(startMonth) { this.$store.commit('updateSchoolStartMonth1', startMonth) }
            },
            startYear: {
                get() { return this.$store.state.education.school1.startYear },
                set(startYear) { this.$store.commit('updateSchoolStartYear1', startYear) }
            },
            endMonth: {
                get() { return this.$store.state.education.school1.endMonth },
                set(endMonth) { this.$store.commit('updateSchoolEndMonth1', endMonth) }
            },
            endYear: {
                get() { return this.$store.state.education.school1.endYear },
                set(endYear) { this.$store.commit('updateSchoolEndYear1', endYear) }
            },
            location: {
                get() { return this.$store.state.education.school1.location },
                set(location) { this.$store.commit('updateSchoolLocation1', location) }
            },
            merit1: {
                get() { return this.$store.state.education.school1.merit1 },
                set(merit) { this.$store.commit('updateSchoolMerit1_1', merit) }
            },
            merit2: {
                get() { return this.$store.state.education.school1.merit2 },
                set(merit) { this.$store.commit('updateSchoolMerit2_1', merit) }
            },
            merit3: {
                get() { return this.$store.state.education.school1.merit3 },
                set(merit) { this.$store.commit('updateSchoolMerit3_1', merit) }
            },
            merit4: {
                get() { return this.$store.state.education.school1.merit4 },
                set(merit) { this.$store.commit('updateSchoolMerit4_1', merit) }
            },
            merit5: {
                get() { return this.$store.state.education.school1.merit5 },
                set(merit) { this.$store.commit('updateSchoolMerit5_1', merit) }
            },
            merit6: {
                get() { return this.$store.state.education.school1.merit6 },
                set(merit) { this.$store.commit('updateSchoolMerit6_1', merit) }
            },
        },
        methods: {
            addMeritField(){
                if(this.$store.state.education.school1.schoolName === ''){

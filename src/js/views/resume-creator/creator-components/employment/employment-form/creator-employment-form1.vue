...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            isValid(){ return !this.$store.state.employment.company1.companyName },
            companyName: {
                get() { return this.$store.state.employment.company1.companyName },
                set(companyName) { this.$store.commit('updateCompanyName1', companyName) }
            },
            startMonth: {
                get() { return this.$store.state.employment.company1.startMonth },
                set(startMonth) { this.$store.commit('updateCompanyStartMonth1', startMonth) }
            },
            startYear: {
                get() { return this.$store.state.employment.company1.startYear },
                set(startYear) { this.$store.commit('updateCompanyStartYear1', startYear) }
            },
            endMonth: {
                get() { return this.$store.state.employment.company1.endMonth },
                set(endMonth) { this.$store.commit('updateCompanyEndMonth1', endMonth) }
            },
            endYear: {
                get() { return this.$store.state.employment.company1.endYear },
                set(endYear) { this.$store.commit('updateCompanyEndYear1', endYear) }
            },
            location: {
                get() { return this.$store.state.employment.company1.location },
                set(location) { this.$store.commit('updateCompanyLocation1', location) }
            },
            title1: {
                get() { return this.$store.state.employment.company1.title1 },
                set(title1) { this.$store.commit('updateCompanyTitle1_1', title1) }
            },
            task1A: {
                get() { return this.$store.state.employment.company1.task1A },
                set(task) { this.$store.commit('updateCompanyTask1A_1', task) }
            },
            task1B: {
                get() { return this.$store.state.employment.company1.task1B },
                set(task) { this.$store.commit('updateCompanyTask1B_1', task) }
            },
            task1C: {
                get() { return this.$store.state.employment.company1.task1C },
                set(task) { this.$store.commit('updateCompanyTask1C_1', task) }
            },
            task1D: {
                get() { return this.$store.state.employment.company1.task1D },
                set(task) { this.$store.commit('updateCompanyTask1D_1', task) }
            },
            task1E: {
                get() { return this.$store.state.employment.company1.task1E },
                set(task) { this.$store.commit('updateCompanyTask1E_1', task) }
            },
            task1F: {
                get() { return this.$store.state.employment.company1.task1F },
                set(task) { this.$store.commit('updateCompanyTask1F_1', task) }
            },
            title2: {
                get() { return this.$store.state.employment.company1.title2 },
                set(title) { this.$store.commit('updateCompanyTitle2_1', title) }
            },
            task2A: {
                get() { return this.$store.state.employment.company1.task2A },
                set(task) { this.$store.commit('updateCompanyTask2A_1', task) }
            },
            task2B: {
                get() { return this.$store.state.employment.company1.task2B },
                set(task) { this.$store.commit('updateCompanyTask2B_1', task) }
            },
            task2C: {
                get() { return this.$store.state.employment.company1.task2C },
                set(task) { this.$store.commit('updateCompanyTask2C_1', task) }
            },
            task2D: {
                get() { return this.$store.state.employment.company1.task2D },
                set(task) { this.$store.commit('updateCompanyTask2D_1', task) }
            },
            task2E: {
                get() { return this.$store.state.employment.company1.task2E },
                set(task) { this.$store.commit('updateCompanyTask2E_1', task) }
            },
            task2F: {
                get() { return this.$store.state.employment.company1.task2F },
                set(task) { this.$store.commit('updateCompanyTask2F_1', task) }
            },
            title3: {
                get() { return this.$store.state.employment.company1.title3 },
                set(title) { this.$store.commit('updateCompanyTitle3_1', title) }
            },
            task3A: {
                get() { return this.$store.state.employment.company1.task3A },
                set(task) { this.$store.commit('updateCompanyTask3A_1', task) }
            },
            task3B: {
                get() { return this.$store.state.employment.company1.task3B },
                set(task) { this.$store.commit('updateCompanyTask3B_1', task) }
            },
            task3C: {
                get() { return this.$store.state.employment.company1.task3C },
                set(task) { this.$store.commit('updateCompanyTask3C_1', task) }
            },
            task3D: {
                get() { return this.$store.state.employment.company1.task3D },
                set(task) { this.$store.commit('updateCompanyTask3D_1', task) }
            },
            task3E: {
                get() { return this.$store.state.employment.company1.task3E },
                set(task) { this.$store.commit('updateCompanyTask3E_1', task) }
            },
            task3F: {
                get() { return this.$store.state.employment.company1.task3F },
                set(task) { this.$store.commit('updateCompanyTask3F_1', task) }
            },
        },
        methods: {
            addTitleField(){
                if(!this.$store.state.employment.company1.companyName){

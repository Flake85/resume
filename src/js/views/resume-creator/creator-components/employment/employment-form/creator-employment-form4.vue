...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            isValid(){ return !this.$store.state.employment.company4.companyName },
            ...
            companyName: {
                get() { return this.$store.state.employment.company4.companyName },
                set(companyName) { this.$store.commit('updateCompanyName4', companyName) }
            },
            startMonth: {
                get() { return this.$store.state.employment.company4.startMonth },
                set(startMonth) { this.$store.commit('updateCompanyStartMonth4', startMonth) }
            },
            startYear: {
                get() { return this.$store.state.employment.company4.startYear },
                set(startYear) { this.$store.commit('updateCompanyStartYear4', startYear) }
            },
            endMonth: {
                get() { return this.$store.state.employment.company4.endMonth },
                set(endMonth) { this.$store.commit('updateCompanyEndMonth4', endMonth) }
            },
            endYear: {
                get() { return this.$store.state.employment.company4.endYear },
                set(endYear) { this.$store.commit('updateCompanyEndYear4', endYear) }
            },
            location: {
                get() { return this.$store.state.employment.company4.location },
                set(location) { this.$store.commit('updateCompanyLocation4', location) }
            },
            title1: {
                get() { return this.$store.state.employment.company4.title1 },
                set(title1) { this.$store.commit('updateCompanyTitle1_4', title1) }
            },
            task1A: {
                get() { return this.$store.state.employment.company4.task1A },
                set(task) { this.$store.commit('updateCompanyTask1A_4', task) }
            },
            task1B: {
                get() { return this.$store.state.employment.company4.task1B },
                set(task) { this.$store.commit('updateCompanyTask1B_4', task) }
            },
            task1C: {
                get() { return this.$store.state.employment.company4.task1C },
                set(task) { this.$store.commit('updateCompanyTask1C_4', task) }
            },
            task1D: {
                get() { return this.$store.state.employment.company4.task1D },
                set(task) { this.$store.commit('updateCompanyTask1D_4', task) }
            },
            task1E: {
                get() { return this.$store.state.employment.company4.task1E },
                set(task) { this.$store.commit('updateCompanyTask1E_4', task) }
            },
            task1F: {
                get() { return this.$store.state.employment.company4.task1F },
                set(task) { this.$store.commit('updateCompanyTask1F_4', task) }
            },
            title2: {
                get() { return this.$store.state.employment.company4.title2 },
                set(title) { this.$store.commit('updateCompanyTitle2_4', title) }
            },
            task2A: {
                get() { return this.$store.state.employment.company4.task2A },
                set(task) { this.$store.commit('updateCompanyTask2A_4', task) }
            },
            task2B: {
                get() { return this.$store.state.employment.company4.task2B },
                set(task) { this.$store.commit('updateCompanyTask2B_4', task) }
            },
            task2C: {
                get() { return this.$store.state.employment.company4.task2C },
                set(task) { this.$store.commit('updateCompanyTask2C_4', task) }
            },
            task2D: {
                get() { return this.$store.state.employment.company4.task2D },
                set(task) { this.$store.commit('updateCompanyTask2D_4', task) }
            },
            task2E: {
                get() { return this.$store.state.employment.company4.task2E },
                set(task) { this.$store.commit('updateCompanyTask2E_4', task) }
            },
            task2F: {
                get() { return this.$store.state.employment.company4.task2F },
                set(task) { this.$store.commit('updateCompanyTask2F_4', task) }
            },
            title3: {
                get() { return this.$store.state.employment.company4.title3 },
                set(title) { this.$store.commit('updateCompanyTitle3_4', title) }
            },
            task3A: {
                get() { return this.$store.state.employment.company4.task3A },
                set(task) { this.$store.commit('updateCompanyTask3A_4', task) }
            },
            task3B: {
                get() { return this.$store.state.employment.company4.task3B },
                set(task) { this.$store.commit('updateCompanyTask3B_4', task) }
            },
            task3C: {
                get() { return this.$store.state.employment.company4.task3C },
                set(task) { this.$store.commit('updateCompanyTask3C_4', task) }
            },
            task3D: {
                get() { return this.$store.state.employment.company4.task3D },
                set(task) { this.$store.commit('updateCompanyTask3D_4', task) }
            },
            task3E: {
                get() { return this.$store.state.employment.company4.task3E },
                set(task) { this.$store.commit('updateCompanyTask3E_4', task) }
            },
            task3F: {
                get() { return this.$store.state.employment.company4.task3F },
                set(task) { this.$store.commit('updateCompanyTask3F_4', task) }
            },
        },
        methods: {
            addTitleField(){
                if(!this.$store.state.employment.company4.companyName){

...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            isValid(){ return !this.$store.state.employment.company3.companyName },
            companyName: {
                get() { return this.$store.state.employment.company3.companyName },
                set(companyName) { this.$store.commit('updateCompanyName3', companyName) }
            },
            startMonth: {
                get() { return this.$store.state.employment.company3.startMonth },
                set(startMonth) { this.$store.commit('updateCompanyStartMonth3', startMonth) }
            },
            startYear: {
                get() { return this.$store.state.employment.company3.startYear },
                set(startYear) { this.$store.commit('updateCompanyStartYear3', startYear) }
            },
            endMonth: {
                get() { return this.$store.state.employment.company3.endMonth },
                set(endMonth) { this.$store.commit('updateCompanyEndMonth3', endMonth) }
            },
            endYear: {
                get() { return this.$store.state.employment.company3.endYear },
                set(endYear) { this.$store.commit('updateCompanyEndYear3', endYear) }
            },
            location: {
                get() { return this.$store.state.employment.company3.location },
                set(location) { this.$store.commit('updateCompanyLocation3', location) }
            },
            title1: {
                get() { return this.$store.state.employment.company3.title1 },
                set(title1) { this.$store.commit('updateCompanyTitle1_3', title1) }
            },
            task1A: {
                get() { return this.$store.state.employment.company3.task1A },
                set(task) { this.$store.commit('updateCompanyTask1A_3', task) }
            },
            task1B: {
                get() { return this.$store.state.employment.company3.task1B },
                set(task) { this.$store.commit('updateCompanyTask1B_3', task) }
            },
            task1C: {
                get() { return this.$store.state.employment.company3.task1C },
                set(task) { this.$store.commit('updateCompanyTask1C_3', task) }
            },
            task1D: {
                get() { return this.$store.state.employment.company3.task1D },
                set(task) { this.$store.commit('updateCompanyTask1D_3', task) }
            },
            task1E: {
                get() { return this.$store.state.employment.company3.task1E },
                set(task) { this.$store.commit('updateCompanyTask1E_3', task) }
            },
            task1F: {
                get() { return this.$store.state.employment.company3.task1F },
                set(task) { this.$store.commit('updateCompanyTask1F_3', task) }
            },
            title2: {
                get() { return this.$store.state.employment.company3.title2 },
                set(title) { this.$store.commit('updateCompanyTitle2_3', title) }
            },
            task2A: {
                get() { return this.$store.state.employment.company3.task2A },
                set(task) { this.$store.commit('updateCompanyTask2A_3', task) }
            },
            task2B: {
                get() { return this.$store.state.employment.company3.task2B },
                set(task) { this.$store.commit('updateCompanyTask2B_3', task) }
            },
            task2C: {
                get() { return this.$store.state.employment.company3.task2C },
                set(task) { this.$store.commit('updateCompanyTask2C_3', task) }
            },
            task2D: {
                get() { return this.$store.state.employment.company3.task2D },
                set(task) { this.$store.commit('updateCompanyTask2D_3', task) }
            },
            task2E: {
                get() { return this.$store.state.employment.company3.task2E },
                set(task) { this.$store.commit('updateCompanyTask2E_3', task) }
            },
            task2F: {
                get() { return this.$store.state.employment.company3.task2F },
                set(task) { this.$store.commit('updateCompanyTask2F_3', task) }
            },
            title3: {
                get() { return this.$store.state.employment.company3.title3 },
                set(title) { this.$store.commit('updateCompanyTitle3_3', title) }
            },
            task3A: {
                get() { return this.$store.state.employment.company3.task3A },
                set(task) { this.$store.commit('updateCompanyTask3A_3', task) }
            },
            task3B: {
                get() { return this.$store.state.employment.company3.task3B },
                set(task) { this.$store.commit('updateCompanyTask3B_3', task) }
            },
            task3C: {
                get() { return this.$store.state.employment.company3.task3C },
                set(task) { this.$store.commit('updateCompanyTask3C_3', task) }
            },
            task3D: {
                get() { return this.$store.state.employment.company3.task3D },
                set(task) { this.$store.commit('updateCompanyTask3D_3', task) }
            },
            task3E: {
                get() { return this.$store.state.employment.company3.task3E },
                set(task) { this.$store.commit('updateCompanyTask3E_3', task) }
            },
            task3F: {
                get() { return this.$store.state.employment.company3.task3F },
                set(task) { this.$store.commit('updateCompanyTask3F_3', task) }
            },
        },
        methods: {
            addTitleField(){
                if(!this.$store.state.employment.company3.companyName){

...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            isValid(){ return !this.$store.state.employment.company2.companyName },
            companyName: {
                get() { return this.$store.state.employment.company2.companyName },
                set(companyName) { this.$store.commit('updateCompanyName2', companyName) }
            },
            startMonth: {
                get() { return this.$store.state.employment.company2.startMonth },
                set(startMonth) { this.$store.commit('updateCompanyStartMonth2', startMonth) }
            },
            startYear: {
                get() { return this.$store.state.employment.company2.startYear },
                set(startYear) { this.$store.commit('updateCompanyStartYear2', startYear) }
            },
            endMonth: {
                get() { return this.$store.state.employment.company2.endMonth },
                set(endMonth) { this.$store.commit('updateCompanyEndMonth2', endMonth) }
            },
            endYear: {
                get() { return this.$store.state.employment.company2.endYear },
                set(endYear) { this.$store.commit('updateCompanyEndYear2', endYear) }
            },
            location: {
                get() { return this.$store.state.employment.company2.location },
                set(location) { this.$store.commit('updateCompanyLocation2', location) }
            },
            title1: {
                get() { return this.$store.state.employment.company2.title1 },
                set(title1) { this.$store.commit('updateCompanyTitle1_2', title1) }
            },
            task1A: {
                get() { return this.$store.state.employment.company2.task1A },
                set(task) { this.$store.commit('updateCompanyTask1A_2', task) }
            },
            task1B: {
                get() { return this.$store.state.employment.company2.task1B },
                set(task) { this.$store.commit('updateCompanyTask1B_2', task) }
            },
            task1C: {
                get() { return this.$store.state.employment.company2.task1C },
                set(task) { this.$store.commit('updateCompanyTask1C_2', task) }
            },
            task1D: {
                get() { return this.$store.state.employment.company2.task1D },
                set(task) { this.$store.commit('updateCompanyTask1D_2', task) }
            },
            task1E: {
                get() { return this.$store.state.employment.company2.task1E },
                set(task) { this.$store.commit('updateCompanyTask1E_2', task) }
            },
            task1F: {
                get() { return this.$store.state.employment.company2.task1F },
                set(task) { this.$store.commit('updateCompanyTask1F_2', task) }
            },
            title2: {
                get() { return this.$store.state.employment.company2.title2 },
                set(title) { this.$store.commit('updateCompanyTitle2_2', title) }
            },
            task2A: {
                get() { return this.$store.state.employment.company2.task2A },
                set(task) { this.$store.commit('updateCompanyTask2A_2', task) }
            },
            task2B: {
                get() { return this.$store.state.employment.company2.task2B },
                set(task) { this.$store.commit('updateCompanyTask2B_2', task) }
            },
            task2C: {
                get() { return this.$store.state.employment.company2.task2C },
                set(task) { this.$store.commit('updateCompanyTask2C_2', task) }
            },
            task2D: {
                get() { return this.$store.state.employment.company2.task2D },
                set(task) { this.$store.commit('updateCompanyTask2D_2', task) }
            },
            task2E: {
                get() { return this.$store.state.employment.company2.task2E },
                set(task) { this.$store.commit('updateCompanyTask2E_2', task) }
            },
            task2F: {
                get() { return this.$store.state.employment.company2.task2F },
                set(task) { this.$store.commit('updateCompanyTask2F_2', task) }
            },
            title3: {
                get() { return this.$store.state.employment.company2.title3 },
                set(title) { this.$store.commit('updateCompanyTitle3_2', title) }
            },
            task3A: {
                get() { return this.$store.state.employment.company2.task3A },
                set(task) { this.$store.commit('updateCompanyTask3A_2', task) }
            },
            task3B: {
                get() { return this.$store.state.employment.company2.task3B },
                set(task) { this.$store.commit('updateCompanyTask3B_2', task) }
            },
            task3C: {
                get() { return this.$store.state.employment.company2.task3C },
                set(task) { this.$store.commit('updateCompanyTask3C_2', task) }
            },
            task3D: {
                get() { return this.$store.state.employment.company2.task3D },
                set(task) { this.$store.commit('updateCompanyTask3D_2', task) }
            },
            task3E: {
                get() { return this.$store.state.employment.company2.task3E },
                set(task) { this.$store.commit('updateCompanyTask3E_2', task) }
            },
            task3F: {
                get() { return this.$store.state.employment.company2.task3F },
                set(task) { this.$store.commit('updateCompanyTask3F_2', task) }
            },
        },
        methods: {
            addTitleField(){
